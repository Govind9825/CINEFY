...
export default function Home() {
  ...
  <div className="relative mb-16">
    ...
    >
              ...
              <div className="flex justify-between w-full px-8">
                <div className="flex space-x-4">
                  <button
                    ...
                    onMouseEnter={(e) => e.currentTarget.classList.add('hover:shadow-lg', 'hover:shadow-white/20')}
                    onMouseLeave={(e) => e.currentTarget.classList.remove('hover:shadow-lg', 'hover:shadow-white/20')}
                  >
                    ...
                    <span className="absolute inset-0 bg-white/10 transform origin-left scale-x-0 transition-transform duration-500 ease-[cubic-bezier(0.65,0,0.35,1)]"
                      onMouseEnter={(e) => e.currentTarget.parentElement.classList.add('scale-x-100')}
                      onMouseLeave={(e) => e.currentTarget.parentElement.classList.remove('scale-x-100')}
                    ></span>
                  </button>
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => e.currentTarget.classList.add('hover:shadow-lg', 'hover:shadow-blue-400/20')}
                    onMouseLeave={(e) => e.currentTarget.classList.remove('hover:shadow-lg', 'hover:shadow-blue-400/20')}
                  >
                    <span className="relative z-10 flex items-center">
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="absolute inset-0 bg-blue-400/10 transform origin-left scale-x-0 transition-transform duration-500 ease-[cubic-bezier(0.65,0,0.35,1)]"
                      onMouseEnter={(e) => e.currentTarget.parentElement.classList.add('scale-x-100')}
                      onMouseLeave={(e) => e.currentTarget.parentElement.classList.remove('scale-x-100')}
                    ></span>
                  </button>
      ...
      {/* Thumbnail section remains unchanged */}
      <div className="thumbnail-container">
        <div className="thumbnail" ref={thumbnailRef}>
          {sliderData.map((item) => (
            <div className="item relative cursor-pointer hover:opacity-100 opacity-70 transition-opacity" key={item._id}>
              <Image
                src={item.thumbnail}
        ...
        <div className="p-4">
          ...
          <div className="flex justify-between items-center mt-4">
            <button
              ...
              onMouseEnter={(e) => {
                e.currentTarget.classList.add('hover:shadow-white/20');
                e.currentTarget.querySelector('.play-hover').classList.add('scale-x-100');
              }}
              onMouseLeave={(e) => {
                e.currentTarget.classList.remove('hover:shadow-white/20');
                e.currentTarget.querySelector('.play-hover').classList.remove('scale-x-100');
              }}
            >
              <span className="relative z-10 flex items-center">
              ...
              <span 
                className="play-hover absolute inset-0 bg-white/10 transform origin-left scale-x-0 transition-transform duration-500 ease-[cubic-bezier(0.65,0,0.35,1)]"
              ></span>
            </button>
            <button
              onClick={() => streamVideo(item)}
              ...
              onMouseEnter={(e) => {
                e.currentTarget.classList.add('hover:shadow-blue-400/20');
                e.currentTarget.querySelector('.stream-hover').classList.add('scale-x-100');
              }}
              onMouseLeave={(e) => {
                e.currentTarget.classList.remove('hover:shadow-blue-400/20');
                e.currentTarget.querySelector('.stream-hover').classList.remove('scale-x-100');
              }}
            >
              <span className="relative z-10 flex items-center">
                <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span 
                className="stream-hover absolute inset-0 bg-blue-400/10 transform origin-left scale-x-0 transition-transform duration-500 ease-[cubic-bezier(0.65,0,0.35,1)]"
              ></span>
            </button>
          </div>
        </div>
